...
func (res *Response)headersResponse(req *Request) (string){
   ...
   fmt.Println(file[idx:])
	...
	res.Headers[CanonicalHeaderKey("Content-Type")]=MIMETypeByExtension(filepath.Ext(res.FilePath))//???
...
func ReadRequest(br *bufio.Reader,res *Response,conn net.Conn) (*Request, bool, error) {
	req := &Request{}
